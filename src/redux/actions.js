...
export const fetchMapData = (address) => {
  return async (dispatch) => {
    ...
    try {
      const response = await fetch(`https://maps.googleapis.com/maps/api/geocode/json?address=${encodeURIComponent(address)}&key=AIzaSyCiyxqwGhYIKCS9_pZ7vy69YPtDEF6frLk`);
